                ...
                <CardContent className="flex justify-center p-2 sm:p-4">
                  <Calendar
                    ...
                    classNames={{
                      ...
                      head_cell: "text-muted-foreground flex-1 font-medium text-[0.85rem] text-center uppercase tracking-wider",
                      row: "flex w-full mt-2 gap-1",
                      cell: "relative flex-1 p-0 text-center focus-within:relative focus-within:z-20",
                      day: "h-10 sm:h-12 w-full p-0 font-medium hover:bg-white/10 rounded-xl transition-all flex items-center justify-center text-sm sm:text-base",
